...
def run(new_data, power, nomal, short):
    ...
    #Below code does not work according to our expectations
...
#We determined the drowsiness-driving-risk-level based on the time which can prevent driving accident.
